...
namespace
{
    ...
    void parsesGitHubLatestReleaseJson()
    {
        const auto release = StashTrack::parseLatestReleaseJson (R"json(
            {
              "tag_name": "v0.5",
              "html_url": "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/tag/v0.5",
              "assets": [
                {
                  "name": "Source.zip",
                ...
                },
                {
                  ...
                  "browser_download_url": "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/download/v0.5/StashTrackv0.5Setup.exe"
                }
              ]
            }
        )json");
    ...
    void releaseInfoExposesHttpsChangelogUrl()
    {
        ...
        release.releasePageUrl = " https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/tag/v0.6 ";
    ...
    void extractsTagFromReleaseRedirectUrls()
    {
        expect (StashTrack::extractTagFromReleaseUrl (
                    "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/tag/v0.7") == "v0.7",
                "tag extractor should read the tag from a release page URL");

        expect (StashTrack::extractTagFromReleaseUrl (
                    "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/tag/v0.7?foo=1#notes") == "v0.7",
                "tag extractor should strip query strings and fragments");

        expect (StashTrack::extractTagFromReleaseUrl (
                    "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/latest").isEmpty(),
    ...
    void redirectFallbackBuildsValidReleaseInfo()
    {
        const auto info = StashTrack::releaseInfoFromTagUrl (
            "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/tag/v0.7");
