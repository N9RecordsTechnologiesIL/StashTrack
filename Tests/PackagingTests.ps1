...
Assert-Contains $cmake 'project(StashTrack VERSION 0.8.0)' 'CMake project must be named StashTrack with version 0.8.0.'
...
Assert-Contains $readme 'Version: v0.8' 'README must document the preferred display version.'
...
foreach ($required in @(
    'AppName=StashTrack',
    '#define AppVersion "v0.8"',
    '#define AppVersionNumeric "0.8.0"',
    ...
    'Type: filesandordirs; Name: "{localappdata}\Programs\Common\VST3\StashTrack.vst3"',
