...
namespace
{
    constexpr auto latestReleaseApiUrl = "https://api.github.com/repos/N9RecordsTechnologiesIL/StashTrack/releases/latest";
...
LatestReleaseInfo releaseInfoFromTagUrl (const juce::String& tagPageUrl)
{
    ...
    info.installerUrl = "https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/latest/download/StashTrackSetup.exe";
    info.valid = true;
    return info;
}
...
namespace
{
    ...
    {
        const juce::URL url ("https://github.com/N9RecordsTechnologiesIL/StashTrack/releases/latest");
